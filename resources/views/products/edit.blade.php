...
<h5> <i class="bi bi-pencil-square"></i>Edit Product</h5>
            ...
            <div class="col-md-8">
                <form method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            placeholder="Enter Prodect Name" value="{{old('name',$product->name)}}"/> 
                            @if($errors->has('name'))
                  ...
                  <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        @if($errors->has('name'))
                            <div class="invalid-feedback">{{$errors->first("mrp")}}
                        </div>
                        @endif
                    </div>
                    <div class="col-md-6">
                ...
                <div class="col-md-12">
                    ...
                    placeholder="Enter Description">{{old('description',$product->description)}}
                  </textarea>
                  @if($errors->has('name'))
                ...
                <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            @if($errors->has('name'))
                            <div class="invalid-feedback">{{$errors->first("image",$product->image)}}
                        </div>
                        @endif
                            </label>
                        </div>
